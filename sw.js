// MétéoScan Pro — Service Worker V3.9
// Notifications push locales

const CACHE_NAME = 'meteoscan-v3.9';

// Installation
// NB : pas de skipWaiting() ici — la nouvelle version reste "en attente" jusqu'à ce
// que l'utilisateur clique sur "Mettre à jour" dans l'appli (message SKIP_WAITING ci-dessous).
// À la toute 1ère installation (aucun SW actif), le worker s'active de toute façon
// immédiatement, et clients.claim() ci-dessous lui donne le contrôle.
...
// Fetch passthrough — ne pas intercepter les requêtes réseau
...
self.addEventListener('message', e => {
  // Demande d'activation immédiate de la nouvelle version (bouton "Mettre à jour")
